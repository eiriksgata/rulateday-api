...
import com.github.eiriksgata.rulateday.dice.service.UserConversationService;
...
import static com.github.eiriksgata.rulateday.dice.service.impl.ApiReportServiceImpl.apiUrl;
...
public class InfiniteLibController {
    ...
    public String infiniteLibOnlineQuery(DiceMessageDTO data) {
        if (!diceConfigMapper.selectById().getBeta_version()) {
