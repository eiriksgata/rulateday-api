...
public class CryptoUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AsymmetricKeyPair asymmetricKeyPair = generateAsymmetricKeyPair(Algorithm.Encryption.RSA_ECB_PKCS1);

        String cipherText = encryptByRSA(asymmetricKeyPair.publicKey, "{data:abc}");
        String sign = signBySHA256WithRSA(asymmetricKeyPair.privateKey, cipherText);

        System.out.println(cipherText);
        System.out.println(sign);
        System.out.println("sign check:" + verifyBySHA256WithRSA(asymmetricKeyPair.publicKey,cipherText, sign ));
