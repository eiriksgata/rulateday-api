...
public class VerifyImageUtil {
     ...
     * @throws Exception
     */
    public static TemplateCutResult pictureTemplatesCut(File templateFile, File targetFile) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        File srcPicture = new File("resources/verify/background/1.jpg");
        File templatePicture = new File("resources/verify/template/1.png");

        TemplateCutResult result = pictureTemplatesCut(templatePicture, srcPicture);

        System.out.println(result.getSlider());
