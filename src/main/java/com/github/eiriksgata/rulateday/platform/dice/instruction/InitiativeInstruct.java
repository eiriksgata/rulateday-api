...
import com.github.eiriksgata.rulateday.platform.dice.service.UserInitiativeService;
...
@InstructService
@Component
public class InitiativeInstruct {
    ...
    public String delAtk(DiceMessageDTO data) {
        ...
        initiativeService.deleteDice(groupId, data.getMessageEvent().getUser_id(), name);
    ...
    public String generateInitiativeDice(DiceMessageDTO data) {
        ...
        name[0] = data.getMessageEvent().getSender().getNickname();
        ...
        rollBasics.rollRandom(diceFace, data.getSanderId(), (i, s) -> {
            ...
            String name1 = data.getMessageEvent().getSender().getNickname();
