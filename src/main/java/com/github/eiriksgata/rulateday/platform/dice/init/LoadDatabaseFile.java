package com.github.eiriksgata.rulateday.platform.dice.init;
...
import com.github.eiriksgata.rulateday.platform.dice.utlis.JSONFileUtils;
...
public class LoadDatabaseFile {
    ...
    public static void createCustomTextConfigFile() throws IOException {
        ...
        String filePath = "config/com.github.eiriksgata.rulateday-dice/";
        ...
        File file = new File(directory, customTextConfigFileName);
